...
public class Example {
    public static void main(String[] args) {
        ...
        // 7. reply 객체에서 board 객체와 category 객체 알 수 있다? [O]
        // 7. category 객체에서 board와 reply 객체 알 수 있다? [X]
        // System.out.println( category.getBoard() );

        // [양방향], 데이터베이스 미사용, 자바 가능
        // 7. reply 객체에서 board 객체와 category 객체 알 수 있다? [O]
        // 7. category 객체에서 board와 reply 객체 알 수 있다? [O]
