...
public class ExamService {
    ...
    public boolean post( ExamDto examDto ){
        // 1. DTO에 영속성(자바객체<-->DB 매핑 상태)을 부여할 수 없고 DTO를 ENTITY 변환하기
        // * 비영속성
    ...
    public List< ExamDto > get(){
        ...
        return entity1List.stream() // 스트림 생성
               ...
               // .map( entity::toDto ) // 메소드 레퍼런스
                .collect( Collectors.toList() ); // 결과
        // 2. 심플
//        List< ExamDto > examDtos = new ArrayList<>();
//        for( int i = 0 ; i < entity1List.size() ; i++ ){
//            ExamEntity1 examEntity1 = entity1List.get(i);
//            ExamDto examDto = examEntity1.toDto();
